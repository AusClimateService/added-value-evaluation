...
def potential_added_value(da_gcm, da_rcm, process, process_kwargs={}, distance_measure="PAVdiff", region=None, return_X=False, agcd_mask=False):
...
def main():
    ...
    #< Calculate added value
    if args.return_X:
        pav, X_gcm, X_rcm = potential_added_value(da_gcm, da_rcm, args.process, args.process_kwargs, distance_measure=args.distance_measure, region=args.region, return_X=args.return_X, agcd_mask=args.agcd_mask)
    else:
        pav = potential_added_value(da_gcm, da_rcm, args.process, args.process_kwargs, distance_measure=args.distance_measure, region=args.region, return_X=args.return_X, agcd_mask=args.agcd_mask)
